...
DROP TABLE cum_batting_stats;

CREATE TABLE cum_batting_stats (
...
ALTER TABLE cum_batting_stats ADD INDEX(groupingId);
ALTER TABLE cum_batting_stats ADD INDEX(groupingDescription(255));
ALTER TABLE cum_batting_stats ADD INDEX(majorLeagueId);
ALTER TABLE cum_batting_stats ADD INDEX(seasonId);
ALTER TABLE cum_batting_stats ADD INDEX(venueId);
ALTER TABLE cum_batting_stats ADD INDEX(teamId);
ALTER TABLE cum_batting_stats ADD INDEX(playerId);
