...
BEGIN
    ...
    DECLARE all_grouping_fields VARCHAR(255) DEFAULT 'positionAbbrev,halfInning,menOnBase,battingTeamId,pitchingTeamId,inning,runnersBeforePlay,outs,majorLeagueId,seasonId,gameType2,teamType,venueId,teamId,playerId';
